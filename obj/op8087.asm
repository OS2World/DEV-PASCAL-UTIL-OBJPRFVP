...
CODE    SEGMENT BYTE PUBLIC
        ...
        PUBLIC  Save8087, Restore8087, Installed_8087, Exceptions8087, Error8087
...
Installed_8087  PROC FAR
        ...
        INC     AX                      ;AX = 1 (True)
Done:   MOV     SP,BX                   ;Restore stack and return
        RET
